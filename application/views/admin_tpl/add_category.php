...
$title 				= (!empty($category_data['title']) ? $category_data['title'] : '');
$meta_title 		= (!empty($category_data['meta_title']) ? $category_data['meta_title'] : '');
$meta_description 	= (!empty($category_data['meta_description']) ? $category_data['meta_description'] : '');
$alias 				= (!empty($category_data['alias']) ? $category_data['alias'] : '');
$thumbnail 			= (!empty($category_data['thumbnail']) ? $category_data['thumbnail'] : '');
$text 				= (!empty($category_data['content']) ? $category_data['content'] : '');
$is_active 			= (!empty($category_data['is_active']) ?  $category_data['is_active'] : '');
?>

<div class="row">
	<div class="col-sm-6 col-xs-12">
		<form action="<?=base_url()?>categories/savecategory" method="post" enctype="multipart/form-data" >
