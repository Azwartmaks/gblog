<!-- MAIN -->
		<main class="index-main">
			...
			<!-- GAME CATEGORY -->
			<section class="section p-t-0 bg-grey">
				<div class="container">
					<div class="showcase-box">
						<div class="row">
							...
							<div class="col-md-4">
								<div class="category-widget">
									<div class="category-media">
										<img class="pic" src="dist/images/cate1.jpg" alt="">
									</div>
							...
							<div class="col-md-4">
								<div class="category-widget">
									<div class="category-media">
										<img class="pic" src="dist/images/cate2.jpg" alt="">
									</div>
									<div class="category-body">
										<div class="category-title">
											FIGHTING
							...
							<div class="col-md-4">
								<div class="category-widget">
									<div class="category-media">
										<img class="pic" src="dist/images/cate3.jpg" alt="">
									</div>
									<div class="category-body">
										<div class="category-title">
											FIGHTING
							...
							<div class="col-md-12">
								<div class="button-box">
									<div class="btn -with-strip">Смотреть все категории</div>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="container">
					...
					<div class="row">
						<article class="col-md-4">
							<div class="post-vertical">
								<div class="post-thumbnail">
									<img src="/dist/images/game-1.jpg" alt="" class="thumb">
								</div>
								<div class="post-title">
									<a href="#" class="link">Проснувшись однажды утром после беспокойного сна</a>
									<span class="post-meta-data">Его комната, настоящая, разве что </span>
								</div>
							</div>
						</article>
						...
						<article class="col-md-4">
							<div class="post-vertical">
								<div class="post-thumbnail">
									<img src="/dist/images/game-6.jpg" alt="" class="thumb">
								</div>
								<div class="post-title">
									<a href="#" class="link">Проснувшись однажды утром после беспокойного сна</a>
									<span class="post-meta-data">Его комната, настоящая, разве что </span>
						...
						<article class="col-md-4">
							<div class="post-vertical">
								<div class="post-thumbnail">
									<img src="/dist/images/game-2.jpg" alt="" class="thumb">
								</div>
								<div class="post-title">
									<a href="#" class="link">Проснувшись однажды утром после беспокойного сна</a>
									<span class="post-meta-data">Его комната, настоящая, разве что </span>
						...
						<article class="col-md-4">
							<div class="post-vertical">
								<div class="post-thumbnail">
									<img src="/dist/images/game-3.jpg" alt="" class="thumb">
								</div>
								<div class="post-title">
									<a href="#" class="link">Проснувшись однажды утром после беспокойного сна</a>
									<span class="post-meta-data">Его комната, настоящая, разве что </span>
						...
						<article class="col-md-4">
							<div class="post-vertical">
								<div class="post-thumbnail">
									<img src="/dist/images/game-4.jpg" alt="" class="thumb">
								</div>
								<div class="post-title">
									<a href="#" class="link">Проснувшись однажды утром после беспокойного сна</a>
									<span class="post-meta-data">Его комната, настоящая, разве что </span>
						...
						<article class="col-md-4">
							<div class="post-vertical">
								<div class="post-thumbnail">
									<img src="/dist/images/game-5.jpg" alt="" class="thumb">
								</div>
								<div class="post-title">
									<a href="#" class="link">Проснувшись однажды утром после беспокойного сна</a>
									<span class="post-meta-data">Его комната, настоящая, разве что </span>
						...
						<div class="col-md-12">
							<div class="button-box">
								<div class="btn -with-strip">Смотреть все новости</div>
							</div>
						</div>
			...
			<div class="banner-container">
				<img class="banner" src="/dist/images/banner-2.jpg" alt="">
			</div>
			...
			<section class="section bg-grey">
				<div class="container">
					...
					<div class="section-title text-center">
						<h2 class="heading">Популярные игры</h2>
					</div>
					...
					<div class="row">
						<article class="col-md-3">
							<div class="post-vertical">
								<div class="post-thumbnail">
									<img src="/dist/images/game-7.jpg" alt="" class="thumb">
								</div>
								<div class="post-title text-center">
									<a href="#" class="link">Проснувшись однажды</a>
								</div>
							</div>
						</article>
						...
						<article class="col-md-3">
							<div class="post-vertical">
								<div class="post-thumbnail">
									<img src="/dist/images/game-8.jpg" alt="" class="thumb">
								</div>
								<div class="post-title text-center">
									<a href="#" class="link">Проснувшись однажды</a>
								</div>
						...
						<article class="col-md-3">
							<div class="post-vertical">
								<div class="post-thumbnail">
									<img src="/dist/images/game-9.jpg" alt="" class="thumb">
								</div>
								<div class="post-title text-center">
									<a href="#" class="link">Проснувшись однажды</a>
								</div>
						...
						<div class="col-md-12">
							<div class="button-box">
								<div class="btn -with-strip">Смотреть все игры</div>
							</div>
						</div>
					</div>
				</div>
			...
			<section class="section">
				<div class="container">
					<div class="col-md-12">
						<div class="section-title text-center">
							<h2 class="heading">Хотите поиграть?</h2>
						</div>
						<div class="section-subtitle">Бесплатные он-лайн игры</div>
					</div>
					<div class="col-sm-6">
						<div class="own-games-unit">
							<div class="own-games-icon">
								<svg class="icon icon-puzzle"><use xlink:href="#icon-puzzle"></use></svg>
							</div>
							<div class="own-games-descr">
								<div class="title">
									Video Poker
								</div>
								<div class="descr">
