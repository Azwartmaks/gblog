...
gulp.task('svgsprite', function() {
    ...
    var stream = gulp.src(config.appImgDir + '/sprite/*.svg')
        .pipe($.svgmin({
            plugins: [{
                removeDoctype: true
            },
        ...
        .pipe(gulp.dest(config.distImgDir + 'sprite/'));
...
gulp.task('default', [ 'styles', 'scripts', 'fonts', 'images', 'watch', 'connect', 'html']);